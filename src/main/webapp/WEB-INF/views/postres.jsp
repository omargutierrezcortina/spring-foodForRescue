...
<html lang="en">
  ...
  <body class="goto-here page-top">
	  <!----------------------------------------------------BARRA------------------------------------------------------------------>
		...
		<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
				<div class="container">
				   <a href="postres.html"> <img class = "logo" src="../frontal_principal/img/logo.final.png" href alt=""></a>
  ...
  <!----------------------------------------------------CARROUSEL------------------------------------------------------------------>
    <!-- END nav -->
	<div class="hero-wrap hero-bread" style="background-image: url('images/Postres/canutillos.jpg');">
		<div class="container">
			  ...
			  <div class="row justify-content-center">
				  <div class="col-md-10 mb-5 text-center">
					  <ul class="product-category">
						  ...
						  <li><a href="#">Frixuelos</a></li>
						  <li><a href="#">Casadielles</a></li>
						  <li><a href="#">Manzana asada</a></li>
						  <li><a href="#">Torrijas</a></li>
					  </ul>
				  </div>
			  </div>
			  <div class="row">
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/arrozconleche.jpg';
							  " onmouseover="this.src='images/postres/arrozconleche2.jpg';" src="images/postres/arrozconleche.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
							  <h3><a href="#">Arroz con leche</a></h3>
							  <div class="d-flex">
								  <div class="pricing">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/lechefrita.jpg';
							  " onmouseover="this.src='images/postres/lechefrita2.jpg';" src="images/postres/lechefrita.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/frixuelos.jpg';
							  " onmouseover="this.src='images/postres/frixuelos2.jpg';" src="images/postres/frixuelos.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
							  <h3><a href="#">Frixuelos</a></h3>
							  <div class="d-flex">
								  <div class="pricing">
									  <p class="price"><span>7,50€/Unidad</span></p>
								  </div>
							  </div>
							  <div class="bottom-area d-flex px-3">
								  <div class="m-auto d-flex">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/casadielles.jpg';
							  " onmouseover="this.src='images/postres/casadielles2.jpg';" src="images/postres/casadielles.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/torrijas.jpg';
							  " onmouseover="this.src='images/postres/torrijas2.jpg';" src="images/postres/torrijas.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
							  <h3><a href="#">Torrijas</a></h3>
							  <div class="d-flex">
								  <div class="pricing">
									  <p class="price"><span>6€/Unidad </span></p>
								  </div>
							  </div>
							  <div class="bottom-area d-flex px-3">
								  <div class="m-auto d-flex">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/borrachinos.jpg';
							  " onmouseover="this.src='images/postres/borrachinos2.jpg';" src="images/postres/borrachinos.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
							  <h3><a href="#">Borrachinos</a></h3>
							  <div class="d-flex">
								  <div class="pricing">
									  <p class="price"><span>5,50€/Unidad</span></p>
								  </div>
							  </div>
							  <div class="bottom-area d-flex px-3">
								  <div class="m-auto d-flex">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/buñuelos.jpg';
							  " onmouseover="this.src='images/postres/buñuelos2.jpg';" src="images/postres/buñuelos.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='images/postres/manzanaasada.jpg';
							  " onmouseover="this.src='images/postres/manzanaasada2.jpg';" src="images/postres/manzanaasada.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
