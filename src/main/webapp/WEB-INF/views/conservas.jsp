		...
		<div class="container">
		  <div class="row no-gutters slider-text align-items-center justify-content-center">
			<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs"><span class="mr-2">Inicio</span> <span>Productos</span></p>			  <h1 class="mb-0 bread">Conservas</h1>
			</div>
		  </div>
		</div>
	  </div>
			  ...
			  <div class="row justify-content-center">
				  <div class="col-md-10 mb-5 text-center">
					  <ul class="product-category">
						  <li><a href="#">Fabada</a></li>
						  <li><a href="#">Cabrito</a></li>
						  <li><a href="#">Miel</a></li>
						  <li><a href="#">Pote</a></li>
						  <li><a href="#">Paté de cabacho</a></li>
					  </ul>
				  </div>
			  </div>
			  <div class="row">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
							  ...
							  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="210" onmouseout="this.src='img/conservas/cabrito.jpg';
								  " onmouseover="this.src='img/conservas/cabrito2.jpg';" src="img/conservas/cabrito.jpg" />
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="210" onmouseout="this.src='img/conservas/pate.jpg';
							  " onmouseover="this.src='img/conservas/pate2.jpg';" src="img/conservas/pate.jpg" />
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="210" onmouseout="this.src='img/conservas/chorizo.jpg';
							  " onmouseover="this.src='img/conservas/chorizocasero.jpg';" src="img/conservas/chorizo.jpg" />
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="210" onmouseout="this.src='img/conservas/pote.jpg';
							  " onmouseover="this.src='img/conservas/pote2.jpg';" src="img/conservas/pote.jpg" />
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="210" onmouseout="this.src='img/conservas/miel.jpg';
							  " onmouseover="this.src='img/conservas/miel2.jpg';" src="img/conservas/miel.jpg" />
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='img/conservas/ternera.jpg';
							  " onmouseover="this.src='img/conservas/ternera2.jpg';" src="img/conservas/ternera.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
				  ...
				  <div class="col-md-6 col-lg-3 ftco-animate">
					  <div class="product">
						  <a href="#" class="img-prod"><img alt="Cambiar imagen" height="205" onmouseout="this.src='img/conservas/cerdoasturcelta.jpg';
							  " onmouseover="this.src='img/conservas/cerdoasturcelta2.jpg';" src="img/conservas/cerdoasturcelta.jpg" />
						  </a>
						  <div class="text py-3 pb-4 px-3 text-center">
